...
bool Deeps::Direct3DInitialize(IDirect3DDevice8* lpDevice)
{
    ...
    if (m_AshitaCore->GetConfigurationManager()->LoadConfiguration("Deeps"))
    {
        xpos = m_AshitaCore->GetConfigurationManager()->GetConfigFloat("Deeps", "xpos", 300.0f);
        ypos = m_AshitaCore->GetConfigurationManager()->GetConfigFloat("Deeps", "ypos", 300.0f);
    }
